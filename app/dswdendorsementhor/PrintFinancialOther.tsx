...
const PrintFinancialOther: React.FC<ChildProps> = ({
  forwardedRef,
  selectedItem,
}) => {
            ...
            <td colSpan={6}>
              ...
              <div className="mt-6">
                <div>
                  ...
                  request for financial assistance for {selectedItem.other} of{' '}
                ...
                <div className="mt-2">
                  ...
                  prescribed to take {selectedItem.maintenance_medicine} as a
                  maintenance medicine for{' '}
                  {selectedItem.patient_gender === 'Male' ? 'his' : 'her'}{' '}
                  condition which is above what{' '}
                  {selectedItem.patient_gender === 'Male' ? 'he' : 'she'} can
                  ill-afford.
                </div>
...
export default PrintFinancialOther
