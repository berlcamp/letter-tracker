...
const PrintHospitalBill: React.FC<ChildProps> = ({
  forwardedRef,
  selectedItem,
}) => {
            ...
            <td colSpan={6}>
              ...
              <div className="mt-6">
                ...
                <div className="mt-2">
                  ...
                  has been admitted to <span>{selectedItem.hospital}</span>
                  by reason of
                  <span>{selectedItem.diagnosis}</span>. As a consequence,
                  {selectedItem.patient_gender === 'Male' ? 'his' : 'her'}{' '}
                  family has incurred a large amount of Medical Bills way above
...
export default PrintHospitalBill
