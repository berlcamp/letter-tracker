...
const PrintFuneralAssistance: React.FC<ChildProps> = ({
  forwardedRef,
  selectedItem,
}) => {
            ...
            <td colSpan={6}>
              ...
              <div className="mt-6">
                <div>
                  ...
                  request for funeral assistance of{' '}
                ...
                <div className="mt-2">
                  ...
                  has ({selectedItem.cause_of_death}) been suffering from
                  {selectedItem.suffering_from} which caused{' '}
                  {selectedItem.patient_gender === 'Male' ? 'his' : 'her'}{' '}
                  demise. As a consequence,
                  {selectedItem.patient_gender === 'Male' ? 'his' : 'her'}{' '}
                  family as represented by{' '}
                  <span className="font-bold uppercase">
                    {selectedItem.requester_fullname}
                  </span>{' '}
                  has incurred a large amount of funeral expenses way above what
                  they can ill-afford.
                </div>
...
export default PrintFuneralAssistance
