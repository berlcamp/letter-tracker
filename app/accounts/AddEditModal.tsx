...
const AddEditModal = ({ hideModal, editData }: ModalProps) => {
  ...
  const [departmentId, setDepartmentId] = useState(
    editData ? (editData.department_id ? editData.department_id : "") : ""
  );
        ...
        .then(async function (response) {
          if (response.data.error_message === "") {
            ...
            const dept: any = departments.find(
              (item: DepartmentTypes) =>
                item.id.toString() === formdata.department_id
            );
            ...
            const updatedData = {
              ...
              dum_departments: { name: dept.name },
            };
  ...
  const handleUpdate = async (formdata: AccountTypes) => {
    ...
    try {
      ...
      const dept: any = departments.find(
        (item: DepartmentTypes) => item.id.toString() === formdata.department_id
      );
